...
This repo describes a hardware modification I made to my Exidy Sorcerer in 1980 to increase its
clock rate from 2Mhz to 3.16Mhz, switchable.

Before we start cutting traces I must warn you that the increased speed will not work with cassette or disk 
...
<img src="/Images/figure-2.jpg" alt="" style="width:70%; height:auto;">
</div>
...
<div style="text-align:center">
<img src="/Images/figure-1.jpg" alt="" style="width:70%; height:auto;">
</div>

But with the new speed-up mod, all I have done is to replace the divide by three sec:tion with a divide by two counter altering the final CPU clock to become 3.15 Mhz.
...
- Locate IC`s 5A and 6A. Then locate the trace that runs 
...
diagram of IC`s 6A and 5A for exact location and extent of 
trace to cut).
